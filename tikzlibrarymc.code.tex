\ProvidesFile{tikzlibrarymc.code.tex}[2025/05/01 v1.3.0 A tikz library for matrix computations and linear algebra]
...
\tikzset {
    ...
    \tikzmath{
      ...
      for \mc@i in {1,...,(#2)}{
        for \mc@j in {1,...,(#3)}{
          ...
          \mc@temp = #1{\mc@i,\mc@j};
          print{[\mc@i,\mc@j]:\ \pgfmathprintnumber{\mc@temp}, \ \ };
        };
        print{\\};
      };
    }%tikzmath
  ...
  mat/combine/.code args={#1,#2,#3,#4,#5,#6,#7}{
    \tikzmath{
      ...
      for \mc@i in {1,...,(#3)}{
        for \mc@j in {1,...,(#4)}{
          % #7{\mc@i,\mc@j} = (#5) * #1{\mc@i,\mc@j} + (#6) * #2{\mc@i,\mc@j};
    ...
    \tikzmath{
      ...
      for \mc@i in {1,...,(#3)}{
        for \mc@j in {1,...,(#3)}{
          ...
          for \mc@k in {1,...,(#3)}{
            for \mc@l in {1,...,(#3)}{
              #4{\mc@i,\mc@j} = \fpeval{#4{\mc@i,\mc@j} + 

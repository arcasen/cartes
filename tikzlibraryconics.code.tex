...
\tikzset{
  ...
  % conics/select distinct={\A,\B,\C,\D}
  % if A != C, result D = A
  % if B != C, result D = B
  % else throw pgferror
  conics/equal/.code args={#1,#2,#3}{
    \tikzmath{
      if abs((#1{1,1})*(#2{3,1})-(#2{1,1})*(#1{3,1})) < \EPSILON && 
      abs((#1{2,1})*(#2{3,1})-(#2{2,1})*(#1{3,1})) < \EPSILON && 
      abs((#1{1,1})*(#2{2,1})-(#2{1,1})*(#1{2,1})) < \EPSILON then {
        #3 = 1;
      } else {
        #3 = 0;
      };
  ...
  conics/select distinct/.code args={#1,#2,#3,#4}{
    \tikzset{
      conics/equal={#1,#3,\cs@aequal},
      conics/equal={#2,#3,\cs@bequal},
    }
    \tikzmath{
      if \cs@aequal == 0 then {
  ...
  conics/define/focus-directrix/.code args={#1,#2,#3,#4}{
    \tikzmath{
      ...
      \cs@P{1,1} = 1.0;        \cs@P{1,2} = 0.0;        \cs@P{1,3} = -(\cs@fx);
      \cs@P{2,1} = 0.0;        \cs@P{2,2} = 1.0;        \cs@P{2,3} = -(\cs@fy);

...
```latex
![[ ../../../../examples/vector-computations/parallelogram-2a.tikz ]]
```
...
```latex
![[ ../../../../examples/vector-computations/parallelogram-3b.tikz ]]
```
...
```latex
![[ ../../../../examples/vector-computations/midpoint-2d.tikz ]]
```
...
```latex
![[ ../../../../examples/vector-computations/midpoint-3d.tikz ]]
```
...
```latex
![[ ../../../../examples/vector-computations/circle-center-radius.tikz ]]
```
...
```latex
![[ ../../../../examples/vector-computations/segment-of-specified-length.tikz ]]
```
